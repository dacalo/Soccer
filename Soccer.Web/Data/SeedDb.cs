...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("CALD7808244AA", "David", "Chávez", "divadchl@gmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.Admin, "Zulu.jpg");
        ...
        private async Task AddTeamAsync(string name)
        {
            ...
            string imageId = await _imageHelper.UploadBlobAsync(path, "teams");
        ...
        private async Task<string> UploadImageTournamentAsync(string name)
        {
            ...
            return await _imageHelper.UploadBlobAsync(path, "tournaments");
        }
